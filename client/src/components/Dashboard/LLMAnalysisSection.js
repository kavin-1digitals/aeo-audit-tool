    ...
    return (
      <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl shadow-lg border border-purple-100 p-12">
        <div className="text-center text-gray-500">
          ...
          <h3 className="text-lg font-semibold text-gray-700 mb-2">No LLM Signal Data Available</h3>
          <p className="text-sm text-gray-500">Run an audit to see AI conversation analysis</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden">
      ...
      <div className="p-6 border-b border-gray-200">
        <h3 className="text-lg font-semibold text-gray-900">LLM Signal Analysis</h3>
